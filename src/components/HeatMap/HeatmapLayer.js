...
exports.default = (0, _reactLeaflet.withLeaflet)(
  ((_temp = _class =
    (function (_MapLayer) {
      ...
      HeatmapLayer.prototype.createLeafletElement =
      ...
      HeatmapLayer.prototype.componentWillReceiveProps =
      ...
      HeatmapLayer.prototype.updateHeatmapProps = function updateHeatmapProps(
        props
      ) {
      ...
      HeatmapLayer.prototype.updateHeatmapRadius = function updateHeatmapRadius(
        radius,
        blur
      ) {
        if (radius) {
      ...
      HeatmapLayer.prototype.updateHeatmapGradient =
        function updateHeatmapGradient(gradient) {
          if (gradient) {
      ...
      HeatmapLayer.prototype.updateHeatmapMax = function updateHeatmapMax(
        maximum
      ) {
        if (maximum) {
      ...
      HeatmapLayer.prototype.componentWillUnmount =
      ...
      HeatmapLayer.prototype.fitBounds = function fitBounds() {
        ...
        this.props.leaflet.map.fitBounds(
          _leaflet2.default.latLngBounds(
            _leaflet2.default.latLng(sw),
            _leaflet2.default.latLng(ne)
          )
        );
      };

      HeatmapLayer.prototype.componentDidUpdate =
      ...
      HeatmapLayer.prototype.shouldComponentUpdate =
      ...
      HeatmapLayer.prototype._animateZoom = function _animateZoom(e) {
        ...
        var offset = this.props.leaflet.map
        ...
        if (_leaflet2.default.DomUtil.setTransform) {
          ...
          this._el.style[_leaflet2.default.DomUtil.TRANSFORM] =
            _leaflet2.default.DomUtil.getTranslateString(offset) +
            ' scale(' +
            scale +
            ')';
        }
      ...
      HeatmapLayer.prototype.reset = function reset() {
        ...
        if (
          ...
          this._frame = _leaflet2.default.Util.requestAnimFrame(
            this.redraw,
            this
          );
        }
      ...
      HeatmapLayer.prototype.redraw = function redraw() {
        ...
        var accumulateInGrid = function accumulateInGrid(
          points,
          leafletMap,
          bounds
        ) {
        ...
        var getBounds = function getBounds() {
          return new _leaflet2.default.Bounds(
            _leaflet2.default.point([-r, -r]),
            size.add([r, r])
          );
        };
